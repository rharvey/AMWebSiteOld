            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="image.image.label" default="Image" /></td>
			                <td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="image.produit_id.label" default="Produitid" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: imageInstance, field: "produit_id")}</td>
